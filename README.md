...
| `examples/…` | Runnable apps: `go run ./examples/chat` (mock agentic session), `./examples/table` (git-status mock), `./examples/frame` (composition, tabs, and menu), `./examples/demo`, `./examples/statusbar` |
