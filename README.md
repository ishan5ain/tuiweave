...
| `examples/…` | Runnable apps: `go run ./examples/chat` (mock agentic session), `./examples/table` (git-status mock), `./examples/frame` (composition and tabs), `./examples/demo`, `./examples/statusbar` |
